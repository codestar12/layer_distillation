...
layer_epoch=64
model_epoch=1
python ./at_once_replacement.py \
-le=$layer_epoch \
-me=$model_epoch \
-n='prod' \
-ds='cifar10' \
-md=./models/vgg16_cifar10_high/at_once/vgg_"$layer_epoch"_"$model_epoch".h5 \
-rd=./cifar-vgg/cifar10vgg_pretrained.h \
-ld=./logs/vgg16_cifar10_high/at_once_vgg_layer_"$layer_epoch"_model_"$model_epoch".json
